...
public class TestImageWindowCombinations extends StackWindow {
   ...
   public TestImageWindowCombinations(final ImagePlus plus ) {
      super(plus);
      plus_ = plus;
      initializePrefs();
      ...
      controls.setLayout( new MigLayout( "insets 1, fill"));
      JButton testBut = new JButton("Thest buton");
      Label testLabel = new Label( "Label test");
      controls.add(testBut, "align center, wrap");
      controls.add( testLabel, "align center, wrap");
